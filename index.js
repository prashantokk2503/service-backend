...
// Route to save new provider (append)
app.post("/providers", (req, res) => {
  const { name, category, phone, whatsapp, lat, lon, rating } = req.body;
  ...
  if (exists) {
    return res.status(409).json({ message: "Provider with this phone already exists" });
  }
...
// Optional: Get backup of providers.json
